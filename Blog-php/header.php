...
<body>
    ...
    <div id="wrapper">
        <header class="tech-header header">
            ...
            <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-dark" data-bs-theme="dark" style="background-color: #FF0000;">
                    <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation" style="background-color: #FF0000;">
